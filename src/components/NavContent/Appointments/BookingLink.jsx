  ...
  return (
    <div className="bg-linear-to-tl from-[#16213E] to-[#1A1A2E] p-6.25 rounded-2xl space-y-4">
      ...
      <div className="md:flex gap-3">
        ...
        <div className="flex items-center justify-center md:justify-around gap-4 bg-gradient-to-b from-[#1E2A5F] to-[#141B44] shadow-[0_1px_4px_rgba(255,255,255,0.3),0_0_15px_rgba(0,123,255,0.5),inset_0_2px_15px_rgba(255,255,255,0.5)] shadow-white-2xl py-0.5 px-2 rounded-xl cursor-pointer">
